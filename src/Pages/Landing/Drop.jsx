    ...
    <div className="flex rounded-lg  justify-start relative  bg-drop min-w-[300px] h-[300px] group  items-start flex-col border-2 hover:border-orange transition-all duration-500 border-solid border-[#524d5a]">
      <div className="flex rounded-lg justify-start items-start flex-col w-full h-full p-5 group-hover:bg-orange bg-transparent transition-all duration-500">
        <img
          ...
          alt=""
        />
        <div className="flex pl-4 -mt-[30px] w-full justify-start items-start flex-col gap-4">
          ...
          <div className="w-full flex justify-between mt-1 items-center gap-3">
            <button className="group-hover:bg-white bg-orange min-w-[201px] max-h-[37px] min-h-[36px] uppercase border-none flex justify-center  max-w-[201px] items-center gap-2 group-hover:text-orange duration-500 transition-all text-white text-base">
              Visit Trackpacs{" "}
              <svg
